...
describe('project zellij', () => {
  ...
  //     expect(stdout).to.match(/Opening new Zellij session.*homelab-cli.*sflab|Attaching to existing Zellij session.*homelab-cli/i)
  //   }
  // })
  ...
  //     expect(error.message).to.match(/zellij.*not found|Failed to open Zellij/i)
  //   } else {
  //     // Success message should mention opening or attaching to session for the project
  //     expect(stdout).to.match(/Opening new Zellij session.*sflab|Attaching to existing Zellij session/i)
  //   }
  // })
  ...
  //     )
  //   } else {
  //     // Success message should mention the config name (opening or attaching)
  //     expect(stdout).to.match(/Opening new Zellij session.*myconfig|Attaching to existing Zellij session.*myconfig/i)
  //   }
  // })
  ...
  //     )
  //   } else {
  //     // Success message should mention opening or attaching to Zellij session
  ...
  //       expect(error.message).to.match(/zellij.*not found|Failed to open Zellij/i)
  //     } else {
  //       expect(stdout).to.match(/Opening new Zellij session.*testconfig.*testproject|Attaching to existing Zellij session.*testconfig/i)
  //     }
  //   })
  // })
  ...
  //       // testproject might not appear if attaching to existing session
