...
## Purpose
Enable users to start stopped Proxmox virtual machines through the homelab-cli, supporting both direct VM ID specification and interactive selection from a filtered list of stopped VMs.
