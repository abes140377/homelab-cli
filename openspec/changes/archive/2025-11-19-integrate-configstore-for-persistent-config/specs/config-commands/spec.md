...
## Purpose
Provides CLI commands for reading and writing persistent configuration values, enabling users to view and modify their homelab-cli settings interactively.
